...
<section class="contentbox">
	<div class="maincontent">
		 ...
		 <div class="fields">
			...
			<label><input type="checkbox" name="check_1" class="checkbox" /> Table de 1</label>
			<label><input type="checkbox" name="check_2" class="checkbox" /> Table de 2</label>
			<label><input type="checkbox" name="check_3" class="checkbox" /> Table de 3</label>
			<label><input type="checkbox" name="check_4" class="checkbox" /> Table de 4</label>
			<label><input type="checkbox" name="check_5" class="checkbox" /> Table de 5</label>
			<label><input type="checkbox" name="check_6" class="checkbox" /> Table de 6</label>
			<label><input type="checkbox" name="check_7" class="checkbox" /> Table de 7</label>
			<label><input type="checkbox" name="check_8" class="checkbox" /> Table de 8</label>
				...
				if (isset($_POST["nombre"]))
					{
						...
						for($i=0; $i<$length; $i++)
						{
							...
							echo "<table>";
								...
								{
									$resultat = $a[$i] * $j;
									echo "<tr><td> ".$j." </td><td> x </td><td> ".$a[$i]." </td><td> = </td><td> $resultat </td></tr>";
								}
								echo "</table><br><br><br>";
						}
					}
